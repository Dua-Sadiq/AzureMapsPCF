...
export class AzureMapsPCF implements ComponentFramework.StandardControl<IInputs, IOutputs> {
    ...
    // Change _state property type from number to string
    ...
    private PageLoaded(): void {
        ...
        try {
            ...
            jQuery("#search_field").autocomplete({
                ...
                select: async function (event: any, ui: any) {
                ...
                .data("ui-autocomplete")._renderItem = (ul: JQuery<HTMLElement>, item: any): any => {                    
    ...
    public getOutputs(): IOutputs {
        return {
            ...
            city: this._city,
            state: this._state != null ? this._state : "",
